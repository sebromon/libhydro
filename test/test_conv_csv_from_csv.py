...
class TestSeriesMeteoFromCsv(unittest.TestCase):
    ...
    def test_full(self):
        ...
        self.assertEqual(
            ...
            ['2011-02-02 14:00:00  10.1    0   16  55.0       0',
             '2011-02-02 14:05:00  20.0    4   16  66.0       0'])
        self.assertEqual(
            seriesmeteo[1].observations.to_string().split('\n')[2:],
            ['2011-02-02 14:00:00  30.0   12   16  100.0       4',
             '2011-02-02 15:00:00  40.0    0   16   75.0       4',
             '2011-02-02 16:00:00  50.5    8   16  100.0       8',
             '2011-02-02 17:00:00   0.0    8   16  100.0       8'])
        # merge = False
